    ...
    if (kIsWeb) {
      ...
      for (final file in files) {
        await ZIMKitCore.instance.coreData.sendMediaMessage(
          ...
          conversationType,
          file.path!,
          audoDetectType ? ZIMKit().getMessageTypeByFileExtension(file) : ZIMMessageType.file,
          preMessageSending: preMessageSending,
          onMessageSent: onMessageSent,
        );
      }
    ...
    if (kIsWeb) {
      ...
      for (var file in files) {
        await ZIMKitCore.instance.coreData.sendMediaMessage(
          ...
          conversationType,
          file.path,
          audoDetectType ? ZIMKit().getMessageTypeByFileExtension2(file) : ZIMMessageType.file,
          preMessageSending: preMessageSending,
          onMessageSent: onMessageSent,
        );
      }
